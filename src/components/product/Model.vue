            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr
                      v-for="model in models.taxonomyContents.data"
                      :key="model.id"
                    >
                      <td>{{ model.id }}</td>
                      ...
                      <td>
                        <a href="#" @click="editModal(model)">
                          <i class="fa fa-edit blue"></i>
                        </a>
                        <a href="#" @click="deleteModel(model.id)">
        ...
        >
          <b-modal ref="my-modal" hide-footer>
            <div class="modal-content">
              ...
              <form @submit.prevent="editmode ? updateType() : addNewType()">
                <div class="modal-body">
                  <div class="form-group">
                    <label>Type</label>
                    <select class="form-control" v-model="form.type" required>
                      <option v-for="(cat, index) in TypesArray" :key="index">{{
                        cat
                      }}</option>
                    </select>
